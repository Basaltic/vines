 ...
 */
export type TriggerEvent = MouseEvent | TouchEvent | KeyboardEvent | React.MouseEvent | React.TouchEvent | React.KeyboardEvent;
 ...
 * ```
 */
export type PredicateParams<Props = any, Data = any> = HandlerParams<Props, Data>;
 ...
 * animation.fade
 */
export type MenuAnimation = string | false | { enter: string | false; exit: string | false };
